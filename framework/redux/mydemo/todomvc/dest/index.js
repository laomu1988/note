...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstrumentation = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoAdd = __webpack_require__(222);
	...
	var _constant = __webpack_require__(226);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            if (filter !== _constant2.default.Show_All) {
	                todos = todos.filter(function (todo) {
	                    return filter === _constant2.default.Show_Complete == todo.complete;
	                });
	            }
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_TodoAdd2.default, { onAddClick: function onAddClick(text) {
	                        return dispatch(_action2.default.todoAdd(text));
	                    } }),
	                _react2.default.createElement(_TodoList2.default, { todos: todos, onTodoClick: function onTodoClick(id) {
	                        return dispatch(_action2.default.todoSwitch(id));
	                    } }),
	                _react2.default.createElement(_Filter2.default, { changeFilter: function changeFilter(filter) {
	                        return dispatch(_action2.default.changeFilter(filter));
	                    } })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoAdd = function (_Component) {
	    ...
	    function TodoAdd() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoAdd).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.todos.map(function (todo, index) {
	                    return _react2.default.createElement(_Todo2.default, { key: todo.id, todo: todo, onTodoClick: onTodoClick });
	                })
	            );
	        }
	    }]);
	...
	var Todo = function (_Component) {
	    ...
	    _createClass(Todo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'li',
	                { className: todo.complete ? 'todo complete' : 'todo', todo_id: todo.id,
	                    onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    todoAdd: function todoAdd(text) {
	        return { type: _constant2.default.Todo_Add, text: text };
	    },
	    todoRemove: function todoRemove(id) {
	        return { type: _constant2.default.Todo_Remove, id: id };
	    },
	    todoComplete: function todoComplete(id) {
	        return { type: _constant2.default.Todo_Complete, id: id };
	    },
	    todoSwitch: function todoSwitch(id) {
	        return { type: _constant2.default.Todo_Switch, id: id };
	    },
	    todoActive: function todoActive(id) {
	        return { type: _constant2.default.todoActive, id: id };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (state, action) {
	    ...
	    switch (action.type) {
	        case _constant2.default.Todo_Add:
	            return [{
	                id: state.reduce(function (prev, todo) {
	                    return Math.max(prev, todo.id);
	                }, 0) + 1,
	                text: action.text,
	                complete: false
	            }].concat(_toConsumableArray(state));
	        case _constant2.default.Todo_Complete:
	            ...
	            return todos;
	        case _constant2.default.Todo_Active:
	            var todos = Object.assign(state);
	            todos = todos.map(function (todo) {
	                if (todo.id === action.id) {
	                    todo = Object.assign(todo);
	            ...
	            return todos;
	        case _constant2.default.Todo_Switch:
	            var todos = Object.assign(state);
	            todos = todos.map(function (todo) {
	                if (todo.id === action.id) {
	                    todo = Object.assign(todo);
	            ...
	            return todos;
	        case _constant2.default.Todo_Remove:
	            var todos = Object.assign(state);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (state, action) {
	    if (typeof state === 'undefined') {
	        return _constant2.default.Show_All;
	    }
	    switch (action.type) {
	        case _constant2.default.Show_All:
	        case _constant2.default.Show_Active:
	        case _constant2.default.Show_Complete:
	            return action.type;
	        default:
	            return state;
	    }
